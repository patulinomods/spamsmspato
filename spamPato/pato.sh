...
sleep 1
echo -e ""$G"SPAM BY PATO"
echo -e ""$G"Instalando calama ai..."
sleep 1
...
echo -e ""$E"deu merda e n foi possivel instalar ._."
exit
fi
...
sleep 1
echo -e ""$S"Instalaçao concluida, bo spamar kkkkkkkk!"
sleep 1
